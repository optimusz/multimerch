<div class="box">
  <div class="box-heading"><?php echo $ms_topsellers_sellers; ?></div>
  <div class="box-content">
    ...
    <p style="text-align: right; margin: 0"><a href="<?php echo $sellers_href ?>"><?php echo $ms_topsellers_view; ?></a></p>
	<?php } else { ?>
