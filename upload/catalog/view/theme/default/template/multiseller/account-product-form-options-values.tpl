<div class="option">
	...
	<div class="o-heading"><span class="option_required <?php echo isset($option['required']) && !$option['required'] ? "bw" : ""; ?>" title="Required"></span><?php echo $option['name']; ?><a class="ms-button-delete option_delete" title="<?php echo $ms_delete; ?>"></a></div>
	...
	<div class="o-content">
		<div class="option_values mmCtr">
			<div class="option_value ffSample">
				...
				<span class="option_price_prefix plus" title="Change price prefix"></span>
				<span class="option_price">
					<?php echo $this->currency->getSymbolLeft(); ?>
					<input type="text" placeholder="Price..." name="product_option[<?php echo $option_index; ?>][product_option_value][0][price]" value="" size="5"></td>
					<?php echo $this->currency->getSymbolRight(); ?>
				</span>
				<input class="option_quantity" type="text" placeholder="Quantity..." name="product_option[<?php echo $option_index; ?>][product_option_value][0][quantity]" value="" size="5"></td>
			...
			<?php foreach ($product_option_values as $value) {?>
				<div class="option_value">
					...
					<span class="option_price_prefix <?php echo ($value['price_prefix'] == '+' ? "plus" : "minus"); ?>" title="Change price prefix"></span>
					<span class="option_price">
						<?php echo $this->currency->getSymbolLeft(); ?>
						<input type="text" placeholder="Price..." name="product_option[<?php echo $option_index; ?>][product_option_value][<?php echo $i; ?>][price]" value="<?php echo $value['price']; ?>" size="5"></td>
						<?php echo $this->currency->getSymbolRight(); ?>
					</span>
					<input class="option_quantity" type="text" placeholder="Quantity..." name="product_option[<?php echo $option_index; ?>][product_option_value][<?php echo $i; ?>][quantity]" value="<?php echo $value['quantity']; ?>" size="5"></td>
		...
		<select class="select_option_value" id="select_option_value<?php echo $option['option_id']; ?>">
			<option value="0" disabled="disabled" selected="selected">+ Add value</option>
