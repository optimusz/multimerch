...
class ModelLocalisationOrderStatus extends Model {
	...
	public function editSuborderStatus($suborder_id, $order_status_id) {
		$this->db->query("UPDATE `" . DB_PREFIX . "ms_suborder` SET `order_status_id` = " . $order_status_id . " WHERE `suborder_id` = " . $suborder_id);
	}
